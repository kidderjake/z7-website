  ...
  return <div className="cards-page enquiry-page" id="top">
    ...
    <main className="enquiry-main">
      ...
      <form className="enquiry-form" onSubmit={saveEnquiry} onChange={() => setStatus('')}>
        <fieldset><legend>I’m interested in</legend><div className="enquiry-options"><label><input type="radio" name="offering" value="Website" required defaultChecked/><span>Website</span></label><label><input type="radio" name="offering" value="Free AI Automation Audit"/><span>Free AI Automation Audit</span></label><label><input type="radio" name="offering" value="AI & automation"/><span>AI & automation</span></label><label><input type="radio" name="offering" value="Marketing & growth"/><span>Marketing & growth</span></label></div></fieldset>
